...
class UserModel {
    ...
    static async findById(id) {
        const query = 'SELECT id, username, email, first_name, last_name, role, created_at, image, line_user_id, phone_number FROM users WHERE id = $1';
    ...
    static async editUser(userId, userData) {
        ...
        const query = `
            ...
            SET ${updates.join(', ')}
            WHERE id = $${paramIndex}
            RETURNING id, username, email, first_name, last_name, role, updated_at, image, line_user_id, phone_number
        `;
